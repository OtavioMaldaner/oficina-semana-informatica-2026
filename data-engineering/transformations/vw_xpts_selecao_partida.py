...
@dp.materialized_view(
    ...
    schema="""
        ...
        team_id INT CONSTRAINT fk_vw_xpts_team REFERENCES fifa_world_cup_2026.gold.dim_selecoes(team_id) COMMENT 'Selecao analisada.',
        team_name STRING COMMENT 'Nome da selecao analisada.',
        opponent_team_id INT CONSTRAINT fk_vw_xpts_opponent_team REFERENCES fifa_world_cup_2026.gold.dim_selecoes(team_id) COMMENT 'Selecao adversaria.',
